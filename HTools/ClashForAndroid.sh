...
echo -e " ü¶é‚Ä?? Creando Directorios y Archivos"
msg -bar3 
...
echo -e " ü¶é‚Ä?? Clonando Repositorio Original Dreamacro "
...
clear
[[ -e /root/name ]] && figlet -p -f slant < /root/name || echo -e "\033[7;49;35m    =====>>‚ñ∫‚ñ∫ üê≤ New ChumoGHüí•VPS üê≤ ‚óÑ‚óÑ<<=====      \033[0m"
fileon=$(ls -la /var/www/html | grep "yaml" | wc -l)
filelo=$(ls -la /root/.config/clash | grep "yaml" | wc -l)
cd
msg -bar3
echo -e "\033[1;37m ‚à??  Linux Dist: $(less /etc/issue.net)\033[0m"
msg -bar3
echo -e "\033[1;37m ‚à?? Ficheros Online:	$fileon  ‚Ä?? Ficheros Locales: $filelo\033[0m"
msg -bar3
...
#[[ -e /root/name ]] && figlet -p -f slant < /root/name || echo -e "\033[7;49;35m    =====>>‚ñ∫‚ñ∫ üê≤ New ChumoGHüí•VPS üê≤ ‚óÑ‚óÑ<<=====      \033[0m"
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo -e "\033[1;33m√é‚Ä?? Ingresa tu Whatsapp junto a tu codigo de Pais"
read -p " Ejemplo: +593987072611 : " numwt
if [[ -z $numwt ]]; then
numwt='+593987072611'
fi
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo -e "\033[1;33m√é‚Ä?? Ingresa Clase de Servidor ( Gratis - PREMIUM )"

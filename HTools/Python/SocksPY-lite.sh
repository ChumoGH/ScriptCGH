...
SCPinst="/etc/ADMcgh" && [[ ! -d ${SCPinst} ]] && exit
...
gettunel_fun () {
echo "master=CGHPlus" > ${SCPinst}/pwd.pwd
...
msg -bar3
echo -e "\e[91m\e[43m  ==== SCRIPT MOD PLUS|ChumoGH|EDICION ====  \033[0m \033[0;33m[$(less /etc/ADMcgh/v-local.log)]"
msg -bar3
echo -e "${cor[4]} [1] > \033[1;36m  SOCKS SIMPLE $P1"
